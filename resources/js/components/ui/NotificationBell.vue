<template>
  <div class="relative" ref="containerRef">
    ...
    >
      <div
        v-if="open"
        class="fixed inset-x-3 top-16 sm:absolute sm:inset-x-auto sm:right-0 sm:top-full sm:mt-2 sm:w-80 bg-dark-800 border border-dark-700 rounded-2xl shadow-2xl z-50 overflow-hidden origin-top-right"
      >
        <!-- Header -->
