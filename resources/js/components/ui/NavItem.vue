...
const icons: Record<string, string> = {
  ...
  crown:     'M5 16L3 6l5.5 4L12 4l3.5 6L21 6l-2 10H5zm0 0h14v3H5v-3z',
}

const iconComponent = computed(() =>
  h('svg', { fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor', class: 'w-4 h-4 flex-shrink-0' }, [
    h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: icons[props.icon] ?? icons.home }),
  ])
)
</script>
